...
namespace MusicWave.Controllers
{
    public partial class ErrorController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string NotAllow = "~/Views/Error/NotAllow.cshtml";
    ...
    public partial class T4MVC_ErrorController : MusicWave.Controllers.ErrorController
    {
        ...
        [NonAction]
        partial void NotAllowedOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);

        [NonAction]
        public override System.Web.Mvc.ActionResult NotAllowed()
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.NotAllowed);
